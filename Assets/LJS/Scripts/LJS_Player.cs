...
public class LJS_Player : MonoBehaviour
{
    #region 싱글톤 구현
    //------------------------------//
    public static LJS_Player Instance;
    ...
    //{
    //    dashEffect.transform.position = transform.position + new Vector3(0, 0, 1);
    //    dashEffect.transform.forward = transform.up;
    //    if (speed > 80)
    //    {
    //        dashEffect.Play();
    //    }
    ...
    { 
        ...
        {
            // 카메라의 y 회전만 구해온다.
            Quaternion v3Rotation = Quaternion.Euler(0f, LJS_CamRotate.Instance.gameObject.transform.eulerAngles.y, 0f);
    ...
    public void Dash()
    {
        ...
        if (Input.GetKeyDown(KeyCode.LeftShift))
        {
            ...
            // 카메라 흔들림
            // 0.2 의 세기로 1초만큼
            LJS_CamRotate.Instance.OnShakeCamera_Rot(0.2f, 0.2f);
