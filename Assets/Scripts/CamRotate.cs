...
public class CamRotate : MonoBehaviour
{
    ...
    public void SensitiveMove()
    {
        if (Player.Instance.isSensitive == true)
        {
            transform.position = transform.position + Random.insideUnitSphere * (Player.Instance.accel * 0.001f);
        }
        else
            return;
